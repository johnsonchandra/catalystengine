...
import OrgListCurrentAll from '..';

import { addOrg } from '../../../../mutations.gql';

class OrgListCurrentAllPage extends React.Component {
  constructor(props) {
    super(props);
    autoBind(this);
      ...
      <React.Fragment>
        ...
        <Styles.Header className="page-header clearfix">
          <DropdownButton
            bsStyle="default"
            title={SettingsIcon}
            id="dropdownbutton_OrgListCurrentAllPage"
          >
...
OrgListCurrentAllPage.propTypes = {
