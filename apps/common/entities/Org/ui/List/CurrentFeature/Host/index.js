...
class OrgListCurrentFeatureHost extends React.Component {
  constructor(props) {
    super(props);
    autoBind(this);
  }
...
OrgListCurrentFeatureHost.defaultProps = {
  loading: true,
  docs: [],
  total: 0,
  perPage: 12,
...
OrgListCurrentFeatureHost.propTypes = {
...
export default withTrackerSsr((props) => {
  ...
  if (Meteor.isClient) {
    ...
    const publishName = 'listOrgCurrentFeatureHost';
