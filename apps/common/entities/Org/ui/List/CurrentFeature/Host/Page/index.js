...
import OrgListCurrentFeatureHost from '..';

import { StyledHeader } from './styles';

import { addOrg } from '../../../../mutations.gql';

class OrgListCurrentFeatureHostPage extends React.Component {
  constructor(props) {
    super(props);
    autoBind(this);
      ...
      <React.Fragment>
        ...
        <StyledHeader className="page-header clearfix">
          <DropdownButton
            bsStyle="default"
            title={SettingsIcon}
            id="dropdownbutton_OrgListCurrentFeatureHostPage"
          >
            ...
            <MenuItem divider />
            <MenuItem onClick={() => history.push('/Org/draft')}>
              <Icon iconStyle="solid" icon="external-link-alt" />
              {' Draft'}
            </MenuItem>
