...
import Validation from '../../../../../common/ui/components/Validation';
    ...
    return (
      <React.Fragment>
        <Validation
          ...
          messages={{
            nr: {
              required: 'Harap mengisi Nomor Document',
            },
            name: {
              required: 'Harap mengisi Nama Document',
            },
            trxDate: {
              required: 'Harap mengisi Tanggal Document',
            },
            amount: {
            ...
            <Row>
              <Col xs={12} md={6}>
                <Row>
                  <Col xs={12}>
                    <FormGroup>
                      <ControlLabel>Nomor Document</ControlLabel>
                      <input
                        type="text"
                        name="nr"
                        autoComplete="off"
                ...
                <Row>
                  <Col xs={12}>
                    <FormGroup>
                      <ControlLabel>Nama Document</ControlLabel>
                      <input
                        type="text"
                        name="name"
                        autoComplete="off"
                ...
                {!disabled ? (
                  <Button type="submit" bsStyle="success">
                    {doc ? 'Save Changes' : 'Create new Document'}
                  </Button>
                ) : (
                  <div />
                )}
